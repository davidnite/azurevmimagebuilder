Configuration Server2019_MemberServer {
    param
    (
    ...
    #
    # This gives us a score of 93% procent on CIS Microsoft Windows Server 2019 Benchmark v1.2.1 - Level 1 Member Server
    ######################################################################################################################################################################################
    ...
    Node $ComputerName {
        ...
        ######################################################################################################################################################################################
        # CIS & Security Center Standards | Adjustments
        ######################################################################################################################################################################################
        ...
        #  2.2.21 (CIS Baseline Level 1) Ensure 'Deny access to this computer from the network' is set to 'Guests, Local account and member of Administrators group' (MS only)
        #  Adjusted; Allowed Administrators to connect to this computer from the network
        ...
        SecurityOption AccountSecurityOptions {       
            ...
            # Adjusted; Local Admin is not disabeld by DSC due to incompatiblity with our Azure DevOps Pipeline.
                        
            # 2.3.1.5 (CIS Baseline Level 1) Configure 'Accounts: Rename administrator account'
            # Adjusted; Rename of Admin Account is not required because it is default in Azure VMs
            ...
            # Adjusted; Set to 0. Disables logon caching, completly

            # 2.3.11.6 (CIS Baseline Level 1) Ensure 'Network security: Force logoff when logon hours expire' is set to 'Enabled' 
            #Adjusted;  Gave me unexected issues, could not get it to work.

            # 2.3.7.4 (CIS Baseline Level 1) Configure 'Interactive logon: Message text for users attempting to log on' 
            #Adjusted to; 'This system is restricted to authorized users. Individuals who attempt unauthorized access will be prosecuted. If you are unauthorized terminate access now. Click OK to indicate your acceptance of this information.'
        ...
        #  2.2.3 (CIS Baseline Level 1) Ensure 'Access this computer from the network' is set to 'Administrators, Authenticated Users' (MS only)
        ...
        #  2.2.9 (CIS Baseline Level 1) Ensure 'Allow log on through Remote Desktop Services' is set to 'Administrators, Remote Desktop Users' (MS only)
        ...
        #  2.2.18 (CIS Baseline Level 1) Ensure 'Create symbolic links' is set to 'Administrators, NT VIRTUAL MACHINE\Virtual Machines' (MS only)
        ...
        #  2.2.26 (CIS Baseline Level 1) Ensure 'Deny log on through Remote Desktop Services' is set to 'Guests, Local account' (MS only)
        ...
        #  2.2.28 (CIS Baseline Level 1) Ensure 'Enable computer and user accounts to be trusted for delegation' is set to 'No One' (MS only)
        ...
        #  2.2.38 (CIS Baseline Level 1) Ensure 'Manage auditing and security log' is set to 'Administrators' (MS only)
        ...
        #  18.2.2 (CIS Baseline Level 1) Ensure 'Do not allow password expiration time longer than required by policy' is set to 'Enabled' (MS only)
        ...
        #  18.2.3 (CIS Baseline Level 1) Ensure 'Enable Local Admin Password Management' is set to 'Enabled' (MS only)
        ...
        #  18.2.4 (CIS Baseline Level 1) Ensure 'Password Settings: Password Complexity' is set to 'Enabled: Large letters + small letters + numbers + special characters' (MS only)
        ...
        #  18.2.5 (CIS Baseline Level 1) Ensure 'Password Settings: Password Length' is set to 'Enabled: 15 or more' (MS only)
        ...
        #  18.2.6 (CIS Baseline Level 1) Ensure 'Password Settings: Password Age (Days)' is set to 'Enabled: 30 or fewer' (MS only)
        ...
        #  18.3.1 (CIS Baseline Level 1) Ensure 'Apply UAC restrictions to local accounts on network logons' is set to 'Enabled' (MS only)
        ...
        #  18.5.4.1 (CIS Baseline Level 1) Ensure 'Turn off multicast name resolution' is set to 'Enabled' (MS Only)
        #  AZ-WIN-00145
        ...
        #  18.8.28.4 (CIS Baseline Level 1) Ensure 'Enumerate local users on domain-joined computers' is set to 'Disabled' (MS only)
        ...
        #  18.8.37.1 (CIS Baseline Level 1) Ensure 'Enable RPC Endpoint Mapper Client Authentication' is set to 'Enabled' (MS only)
        ...
        #  18.8.37.2 (CIS Baseline Level 2) Ensure 'Restrict Unauthenticated RPC clients' is set to 'Enabled: Authenticated' (MS only)
        ...
        #  18.8.52.1.2 (CIS Baseline Level 2) Ensure 'Enable Windows NTP Server' is set to 'Disabled' (MS only)
        ...
        #  18.9.45.14 (CIS Baseline Level 1) Ensure 'Configure detection for potentially unwanted applications' is set to 'Enabled: Block'
        ...
        #  18.9.45.15 (CIS Baseline Level 1) Ensure 'Turn off Microsoft Defender AntiVirus' is set to 'Disabled'
